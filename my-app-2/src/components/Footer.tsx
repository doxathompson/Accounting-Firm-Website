...
export function Footer() {
  return (
    <footer className="bg-[#0B3C40] text-white">
      <Container size="wide" className="py-14">
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            <p className="text-2xl font-semibold tracking-tight">Harriet Ross.</p>
            <p className="mt-5 max-w-xs text-sm leading-6 text-slate-400">
              Advisory, assurance, and accounting support for businesses writing their next chapter.
            </p>
          </div>
